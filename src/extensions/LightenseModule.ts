...
const Lightense = () => {
  ...
  .lightense-transitioning {
    ...
    function createTransform(img) {
        ...
        var imageCenterX =
            targetImage.left + scrollLeft + targetImage.width / 2;
    ...
    function createViewer() {
        ...
        setTimeout(function () {
            config.target.style.transform =
                "scale(" + config.scaleFactor + ") translateZ(1px)";
        ...
        var item_options = {
            ...
            background:
                ...
                config.background,
            zIndex:
                config.target.getAttribute("data-lightense-z-index") ||
                config.zIndex,
        };
